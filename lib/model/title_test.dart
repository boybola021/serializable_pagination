...
String decryptedAlgorithm(String text) {
  ...
  String res = "";
  for(var i in list){
    res += i.toString().substring(0,1).toUpperCase() +  i.toString().substring(1).toLowerCase();
    res += " ";
  }
  log("====$list===");
  return res;
...
String encryptedAlgorithm(String text) {
  ...
  String res = "";
  for(var i in list){
    res += i.toString().substring(0,1).toLowerCase() +  i.toString().substring(1).toLowerCase();
    res += " ";
  }
  return res;
}
